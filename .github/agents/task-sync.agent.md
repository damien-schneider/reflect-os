---
description: "TaskSync V5 autonomous task execution agent. Continuously accepts and executes tasks via terminal input, maintaining indefinite operation until explicit user termination. Handles task queuing, status tracking, and mandatory continuation protocols. Use for long-running task workflows requiring autonomous execution cycles."
tools:
  [
    "execute",
    "read",
