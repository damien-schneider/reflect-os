...
export default function Hero() {
  return (
    <section className="mx-auto flex max-w-7xl flex-col items-start px-4 py-12 text-left sm:px-6 sm:py-20 lg:px-8">
      ...
      {/* Headings */}
      <Heading className="mb-6" variant="h1">
      ...
      {/* Dashboard Mockup - Feedback / Roadmap View */}
          ...
          <div className="hidden w-64 flex-col border-border border-r bg-muted/30 md:flex">
            ...
            <div className="p-4">
              ...
              <div className="space-y-1">
                ...
                <div className="flex cursor-pointer items-center gap-2 rounded-lg px-3 py-2 text-muted-foreground text-sm hover:bg-muted">
                  <span className="h-2 w-2 rounded-full bg-blue-500" /> In
                  Progress
                </div>
                <div className="flex cursor-pointer items-center gap-2 rounded-lg px-3 py-2 text-muted-foreground text-sm hover:bg-muted">
          ...
          <div className="flex min-w-0 flex-1 flex-col bg-card">
            ...
            <div className="flex-1 space-y-8 overflow-y-auto p-6">
              <div className="prose prose-sm max-w-none text-muted-foreground">
                <p>
                  It would be great to have a dark mode for the application.
                  Working late at night with the bright white background is
                  straining for the eyes.
                </p>
                <p>
                  Ideally, this should sync with the system preferences but also
                  allow a manual override in the settings.
                </p>
              </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="rounded-lg rounded-tl-none bg-muted p-3 text-muted-foreground text-sm">
                        Thanks for the feedback! We've added this to our roadmap
                        for Q4.
                      </p>
