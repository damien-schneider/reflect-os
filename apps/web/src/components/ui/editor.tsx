...
const editorVariants = cva(
  cn(
    ...
    "**:data-slate-placeholder:!top-1/2 placeholder:text-muted-foreground **:data-slate-placeholder:-translate-y-1/2 **:data-slate-placeholder:text-muted-foreground **:data-slate-placeholder:opacity-100!",
    "[&_strong]:font-bold"
  ),
  {
    defaultVariants: {
