  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Popup
        className={cn(
          "group/alert-dialog-content fixed top-1/2 left-1/2 z-50 grid w-full -translate-x-1/2 -translate-y-1/2 ending:scale-95 starting:scale-95 gap-3 rounded-xl bg-background p-4 ending:opacity-0 starting:opacity-0 outline-none ring-1 ring-foreground/10 transition-[opacity,transform] duration-150 data-[size=default]:max-w-xs data-[size=sm]:max-w-64 data-[size=default]:sm:max-w-sm",
          className
        )}
        data-size={size}
