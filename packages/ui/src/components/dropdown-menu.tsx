  ...
  return (
    <MenuPrimitive.Portal>
      ...
      >
        <MenuPrimitive.Popup
          className={cn(
            "z-50 max-h-(--available-height) w-(--anchor-width) min-w-32 origin-(--transform-origin) overflow-y-auto overflow-x-hidden rounded-lg bg-popover p-1 text-popover-foreground shadow-md outline-none ring-1 ring-foreground/10",
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuContent
      ...
      alignOffset={alignOffset}
      className={cn(
        "w-auto min-w-32 rounded-lg bg-popover p-1 text-popover-foreground shadow-md ring-1 ring-foreground/10",
        "transition-[opacity,transform] duration-150",
        "starting:scale-95 starting:opacity-0",
        "ending:scale-95 ending:opacity-0",
        className
