...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: role="group" is appropriate for form field grouping
    <div
...
function FieldError({
  ...
  const content = useMemo(() => {
    ...
    // biome-ignore lint/suspicious/noDoubleEquals: intentional loose equality for length check
