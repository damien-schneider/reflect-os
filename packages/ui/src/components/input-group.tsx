...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: role="group" is appropriate for input groups
    <div
      className={cn(
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: role="group" is appropriate for input addon groups
    // biome-ignore lint/a11y/noNoninteractiveElementInteractions: onClick focuses input for better UX
    // biome-ignore lint/a11y/useKeyWithClickEvents: keyboard focus is handled by the input itself
    <div
